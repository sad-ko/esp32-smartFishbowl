...
const String g_events_str[] = {
    "EV_CAPTURED",      "EV_FISHES_FED",      "EV_DIRTY_WATER",
    "EV_TANK_FILLED",   "EV_TIME_CHANGED",    "EV_MINIMUN_WATER",
    "EV_HUNGRY_FISHES", "EV_MQTT_DRAW_WATER", "EV_MQTT_FEED_FISHES"};

// clang-format off

///@brief Tabla de estados
const transition g_state_table[MAX_STATES][MAX_EVENTS] = {
    {action_init,        action_error,      action_error,      action_error,      action_error,     action_error,         action_error,       action_error,          action_error}, // ST_INIT
    {action_none,         action_none, action_draw_start,       action_none, action_night_time, action_tank_stop, action_feeding_start,  action_draw_start,  action_feeding_start}, // ST_IDLE
    {action_none,         action_none,       action_none,       action_none,   action_day_time, action_tank_stop,          action_none,  action_draw_start,  action_feeding_start}, // ST_IDLE_NIGHT
    {action_none,         action_none,       action_none, action_tank_start,       action_none, action_tank_stop,          action_none,  action_draw_start,  action_feeding_start}, // ST_LOW_ON_WATER
    {action_none,         action_none,       action_none,       action_none,       action_none, action_draw_stop,          action_none,  action_draw_start,  action_feeding_start}, // ST_DRAWING_WATER
    {action_none, action_feeding_stop,       action_none,       action_none,       action_none, action_tank_stop,          action_none,  action_draw_start,  action_feeding_start}, // ST_FEEDING_FISHES

  // EV_CAPTURED,       EV_FISHES_FED,    EV_DIRTY_WATER,    EV_TANK_FILLED,   EV_TIME_CHANGED, EV_MINIMUN_WATER,     EV_HUNGRY_FISHES, EV_MQTT_DRAW_WATER,   EV_MQTT_FEED_FISHES
};
// clang-format on
...
void action_tank_start() { change_state(ST_IDLE); }
